    ...
    String savePath = request.getSession().getServletContext().getRealPath("/") + "background/kindeditor/attached/";   
    //文件保存目录URL /kindeditor/attached/  
    String saveUrl = request.getContextPath() + "/background/kindeditor/attached/";   
    //定义允许上传的文件扩展名   
    //定义允许上传的文件扩展名   
