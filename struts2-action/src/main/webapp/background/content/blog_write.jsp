...
<div class="content-box">
	...
	<div class="content-box-content">
		<div class="tab-content default-tab" id="tab2">
			<form action="Blog!writeBlog" method="post" name="example">
				<fieldset>
					<p>
						<label>标题</label>
						<input class="text-input small-input" type="text" id="small-input"	name="blog.title" />
<!-- 						 <span class="input-notification success png_bg">Successful	message</span> -->
<!-- 						 <br /> <small>A small description of the field</small> -->
					</p>
					<p>
						<label>标签</label> 
						<input class="text-input medium-input datepicker" type="text" id="medium-input" name="blog.tags" /> 
<!-- 						<span class="input-notification error png_bg">Error message</span> -->
						<small>标签之间以逗号隔开，如”裸分，教育“</small>
					</p>
					<p>
						<label>简介</label> <input class="text-input large-input" type="text" id="large-input" name="blog.intro" />
					</p>
<!-- 					<p> -->
<!-- 						<label>标签</label>  -->
