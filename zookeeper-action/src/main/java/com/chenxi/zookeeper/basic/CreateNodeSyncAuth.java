...
public class CreateNodeSyncAuth implements Watcher {
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		zookeeper = new ZooKeeper("192.168.208.128:2181", 5000, new CreateNodeSyncAuth());
	...
	/*
	 * 权限模式(scheme): ip, digest 授权对象(ID) ip权限模式: 具体的ip地址 digest权限模式:
	...
	private void doSomething() {
		try {
			...
			ACL aclIp = new ACL(Perms.READ, new Id("ip", "192.168.208.128"));
